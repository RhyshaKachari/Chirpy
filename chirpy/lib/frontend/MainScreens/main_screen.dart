...
import 'package:chirpy/FrontEnd/MenuScreens/about_screen.dart';
import 'package:chirpy/FrontEnd/MenuScreens/profile_screen.dart';
import 'package:chirpy/FrontEnd/MenuScreens/settings_screen.dart';
import 'package:chirpy/FrontEnd/MenuScreens/SupportScreens/support_screen.dart';
  ...
  Widget _drawer() {
    return Drawer(
      ...
      child: Container(
        ...
        color: const Color.fromARGB(239, 46, 38, 78),
        child: ListView(
          shrinkWrap: true,
          children: [
            SizedBox(
